/*
Objetivo: Arquivo responsável pelas rotas de sexo
Data: xx/xx/2026
Autor: Leandro
Versão: 1.0
*/
...
// Criação do objeto Router responsável pelos endpoints de sexo
const router = express.Router()


// Import do controller responsável pelas regras de negócio do sexo
...
// Rota responsável por cadastrar um novo sexo
// Método HTTP: POST
...
// Rota responsável por listar todos os sexos cadastrados
// Método HTTP: GET
// Não necessita receber body na requisição
router.get('/', async function (request, response) {
    
    // Chama o controller responsável por buscar todos os sexos
    let result = await controllerSexo.listarSexo()

    // Retorna o status HTTP recebido do controller
    response.status(result.status_code)

    // Retorna a lista de sexos em formato JSON
    response.json(result)
    
})


// Rota responsável por buscar um sexo pelo ID
// Método HTTP: GET
// Recebe o identificador através dos parâmetros da URL
router.get('/:id', async function (request, response) {

    // Recebe o ID do sexo enviado pela URL
...
// Rota responsável por atualizar um sexo existente
// Método HTTP: PUT
...
// Rota responsável por excluir um sexo existente
// Método HTTP: DELETE
// Recebe o ID através dos parâmetros da URL
router.delete('/:id', async function (request, response) {

    // Recebe o ID do sexo que será excluído
    let id = request.params.id
...
// Exporta o objeto de rotas de sexo para ser utilizado no arquivo principal da aplicação
