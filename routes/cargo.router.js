/*
Objetivo: Arquivo responsável pelas rotas de cargo
Data: xx/xx/2026
Autor: Leandro
Versão: 1.0
*/
...
// Criação do objeto Router responsável pelos endpoints de cargo
const router = express.Router()


// Import do controller responsável pelas regras de negócio do cargo
...
// Rota responsável por cadastrar um novo cargo
// Método HTTP: POST
...
// Rota responsável por listar todos os cargos cadastrados
// Método HTTP: GET
// Não necessita receber body na requisição
router.get('/', async function (request, response) {

    // Chama o controller responsável por buscar todos os cargos
...
// Rota responsável por buscar um cargo pelo ID
// Método HTTP: GET
// Recebe o identificador através dos parâmetros da URL
router.get('/:id', async function (request, response) {

    // Recebe o ID do cargo enviado pela URL
...
// Rota responsável por atualizar um cargo existente
// Método HTTP: PUT
...
// Rota responsável por excluir um cargo existente
// Método HTTP: DELETE
// Recebe o ID através dos parâmetros da URL
router.delete('/:id', async function (request, response) {

    // Recebe o ID do cargo que será excluído
    let id = request.params.id
