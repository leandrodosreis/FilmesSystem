/*
Objetivo: Arquivo responsável pelas rotas de gênero
Data: xx/xx/2026
Autor: Leandro
Versão: 1.0
*/
...
// Criação do objeto Router responsável pelos endpoints de gênero
const router = express.Router()


// Import do controller responsável pelas regras de negócio do gênero
...
// Rota responsável por cadastrar um novo gênero
// Método HTTP: POST
...
// Rota responsável por listar todos os gêneros cadastrados
// Método HTTP: GET
// Não necessita receber body na requisição
router.get('/', async function (request, response) {

    // Chama o controller responsável por buscar todos os gêneros
...
// Rota responsável por buscar um gênero pelo ID
// Método HTTP: GET
// Recebe o identificador através dos parâmetros da URL
router.get('/:id', async function (request, response) {

    // Recebe o ID do gênero enviado pela URL
...
// Rota responsável por atualizar um gênero existente
// Método HTTP: PUT
...
// Rota responsável por excluir um gênero existente
// Método HTTP: DELETE
// Recebe o ID através dos parâmetros da URL
router.delete('/:id', async function (request, response) {

    // Recebe o ID do gênero que será excluído
    let id = request.params.id
...
// Exporta o objeto de rotas de gênero para ser utilizado no arquivo principal da aplicação
